...
- ✅ `source/utilities/format.bas` - 2 GOTO labels → structured control flow (DO...LOOP, IF-ELSEIF-ELSE)
- ✅ **Total:** 12 GOTO labels eliminated (plus 2 in format.bas validated separately)
