...
'
'This module contains parser functions extracted from qb64pe.bas for better modularity.
...
FUNCTION uniquenumber&
    'Generates a unique sequential number for compiler use
...
FUNCTION validname (a$)
    'Validates a variable/identifier name according to QB64 rules
    'notes:
    ...
    DIM l AS LONG, i AS LONG, a AS LONG
    DIM trailingunderscore AS _BYTE, alphabetletter AS _BYTE
...
FUNCTION lineformat$ (a$)
    'Formats a source line by tokenizing and normalizing syntax elements
    'Handles: quoted strings, numbers (decimal/hex/oct/bin), variables/identifiers,
    '         operators, comments, line continuations, and metacommands
    a2$ = ""
    linecontinuation = 0
