...
|--------|-------------|-------|---------------|
| **Graphics** | `libqb/src/graphics.cpp` | 9,241 | `sub_line`, `sub_circle`, `sub_pset`, `sub_paint`, `sub_draw`, `sub__putimage`, GET/PUT, image management |
...
| **State Accessor** | `libqb/src/libqb_state.cpp` | 582 | Image/font/page/screen/fullscreen/resize/filedrop accessors (enables further modularization) |
...
| **Text & Font** | `libqb/src/text.cpp` | 2,126 | `printchr`, `qbs_print`, `qbg_sub_locate`, `sub_cls`, `func_csrlin`, `func_pos`, `func_tab`, `func_spc`, font management (`_LOADFONT`, `_FONT`, `_FREEFONT`), print modes |
...
| **Print Using** | `libqb/src/print_using.cpp` | 926 | `print_using`, `print_using_integer64`, `print_using_uinteger64`, `print_using_single`, `print_using_double`, `print_using_float` - PRINT USING string formatting |
| **Character Set Data** | `libqb/src/charset_data.cpp` | 1,609 | Built-in 8x8 and 8x16 bitmap font data (const arrays) |
| **Static Data** | `libqb/src/static_data.cpp` | 288 | Icon bitmaps (16x16, 32x32), dead character lookup table, QB64 palette data (256-color and EGA) |
...
| Hardware texture mgmt | ~766 | 2600-3400 | **Yes** |
...
| **PRINT USING** | ~926 | Medium | Medium | ✅ **COMPLETED** - Extracted to `print_using.cpp` |
...
libqb.cpp includes 36 modularized headers:
